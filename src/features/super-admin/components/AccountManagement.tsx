...
export default function AccountManagement({
  ...
  return (
    <div id="account-management-module" className="space-y-6">
      ...
      {actionFeedback && (
        <div id="toast-notification" className="fixed bottom-5 right-5 z-50 p-4 rounded-xl border border-amber-500/30 bg-[#0d153a] shadow-2xl animate-bounce flex items-center gap-2.5 max-w-sm">
          <Shield className="text-amber-500 animate-pulse" size={18} />
          <div>
            <p className="text-xs font-bold text-white uppercase tracking-wider">System Broadcast</p>
            <p className="text-[11px] text-slate-300 mt-0.5">{actionFeedback}</p>
          </div>
          <button onClick={() => setActionFeedback(null)} className="ml-auto text-slate-400 hover:text-white">
            <X size={14} />
          </button>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="p-5 rounded-2xl border border-[#17235a]/60 bg-[#070c2e]/80 shadow-2xl relative">
          ...
          <h3 className="text-sm font-bold text-white mt-1">Apex Sovereign Interest Adjustment</h3>
          <p className="text-[#556994] text-xs mt-1">Configure structural compounding yields across checking/savings accounts.</p>

          <div className="mt-5 flex items-center gap-4">
            <div className="relative flex-1">
              <span className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-500 font-mono text-xs font-semibold">% APR</span>
              <input 
        ...
        <div className="p-5 rounded-2xl border border-[#17235a]/60 bg-[#070c2e]/80 shadow-2xl relative">
          ...
          <h3 className="text-sm font-bold text-white mt-1">Secure Electronic Transfer limits</h3>
          <p className="text-[#556994] text-xs mt-1">Assign max daily wire transfer allowances across client profiles.</p>
          ...
          <div className="mt-5 flex items-center gap-4">
            ...
            <button 
              ...
              className={`px-4 py-2.5 rounded-xl text-xs font-bold uppercase transition-all whitespace-nowrap ${
                activeAccount 
                  ? 'bg-gradient-to-r from-blue-500 to-indigo-600 text-white shadow-lg cursor-pointer' 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 p-3 sm:p-5 lg:p-6 rounded-2xl border border-[#17235a]/60 bg-[#070c2e]/80 shadow-2xl space-y-5">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h3 className="text-sm font-bold text-white uppercase tracking-wider">Operational Portfolios Ledger</h3>
              <p className="text-[#556994] text-xs">A comprehensive ledger syncing checking, savings, salary, and high-yield reserve accounts.</p>
            </div>
            ...
            <div className="relative max-w-xs w-full">
              <input
                ...
                className="w-full bg-[#04081c] border border-[#141b44] focus:border-amber-500 text-xs px-3.5 py-2 pl-9 rounded-xl text-white outline-none placeholder-slate-500"
              />
          ...
          <div id="filter-controls-pnl" className="p-4 rounded-xl border border-[#141b44] bg-[#04081c]/70 space-y-3">
                  ...
                  <button
                    ...
                    className={`px-3 py-1 text-[10px] rounded-lg border font-mono font-bold transition-all ${
                      userFilter === u 
                        ...
                        : 'bg-[#060a24]/80 text-slate-400 border-[#141c48] hover:border-slate-700 hover:text-slate-200'
                    }`}
                  >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2">
              <span className="text-[10px] uppercase font-mono font-bold text-slate-400 tracking-wider w-24">Status Gate:</span>
              <div className="flex flex-wrap gap-1.5">
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-3.5 px-3">
                          ...
                          <span className="text-[9px] text-slate-500 font-mono">{acc.ownerId}</span>
                        </td>
        ...
        <div id="account-secure-details-box" className="rounded-2xl border border-[#17235a]/60 bg-[#070c2e]/80 shadow-2xl p-4 sm:p-5 lg:p-6 flex flex-col justify-between relative overflow-y-auto max-h-[1200px] scrollbar-thin">
          ...
          {activeAccount ? (
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 border-b border-[#141b44] pb-4">
                ...
                <div>
                  ...
                  <h4 className="text-md font-bold text-white">{activeAccount.ownerName}</h4>
                  <p className="text-[10px] font-mono text-slate-400">{activeAccount.ownerType} ID: {activeAccount.ownerId}</p>
                </div>
              </div>

              {/* SECTION: Account Holder Information */}
              <div className="space-y-2">
                <p className="text-[10px] font-mono uppercase tracking-widest text-slate-400 font-bold">1. Account Holder Information</p>
                <div className="p-3.5 rounded-xl border border-[#141b44] bg-[#04081c]/60 space-y-2 text-xs w-full max-w-full box-border h-auto min-h-max">
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Full Name:</span>
                    <span className="w-[65%] text-white font-medium text-left break-words [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">{activeAccount.ownerName}</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Registration ID:</span>
                    <span className="w-[65%] text-white font-mono text-left break-words [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">{activeAccount.ownerId}</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Mobile Number:</span>
                    <span className="w-[65%] text-slate-300 font-mono text-left break-words [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">{activeAccount.phone}</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Email Address:</span>
                    <span className="w-[65%] text-slate-300 font-mono text-[11px] text-left break-all [word-break:break-word] [overflow-wrap:break-word] whitespace-normal" title={activeAccount.email}>{activeAccount.email}</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Joining Date:</span>
                    <span className="w-[65%] text-slate-300 font-mono text-left break-words [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">{activeAccount.joinDate}</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Account status:</span>
              ...
              <div className="space-y-2">
                <p className="text-[10px] font-mono uppercase tracking-widest text-slate-400 font-bold">2. Account Information</p>
                <div className="p-3.5 rounded-xl border border-[#141b44] bg-[#04081c]/60 space-y-2 text-xs w-full max-w-full box-border h-auto min-h-max">
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Account Number:</span>
                    <span className="w-[65%] text-white font-mono font-bold tracking-wide text-left break-all [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">{activeAccount.accountNumber}</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Account Type:</span>
                  ...
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Opening Date:</span>
                  ...
                  <div className="flex items-start w-full gap-2 py-0.5 border-t border-[#141b44] pt-2 mt-1.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Current Balance:</span>
                  ...
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Available Balance:</span>
              ...
              <div className="space-y-2">
                <p className="text-[10px] font-mono uppercase tracking-widest text-slate-400 font-bold">3. Branch Information</p>
                <div className="p-3.5 rounded-xl border border-[#141b44] bg-[#04081c]/60 space-y-2 text-xs w-full max-w-full box-border h-auto min-h-max">
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Branch Name:</span>
                    <span className="w-[65%] text-white font-semibold text-left break-words [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">{branchDetail.name}</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Branch Code:</span>
                  ...
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Branch Location:</span>
                    <span className="w-[65%] text-slate-300 text-left break-words [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">{branchDetail.location}</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Regional Zone:</span>
              ...
              <div className="space-y-2">
                <p className="text-[10px] font-mono uppercase tracking-widest text-slate-400 font-bold">4. Branch Manager Information</p>
                <div className="p-3.5 rounded-xl border border-[#141b44] bg-[#04081c]/60 space-y-2 text-xs w-full max-w-full box-border h-auto min-h-max">
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Manager Name:</span>
                    <span className="w-[65%] text-white font-semibold text-left break-words [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">{branchDetail.manager.name}</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Employee ID:</span>
                    <span className="w-[65%] text-white font-mono text-left break-words [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">{branchDetail.manager.empId}</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Designation:</span>
                    <span className="w-[65%] text-slate-300 font-mono font-bold text-[10px] bg-slate-800/60 px-1.5 py-0.5 rounded text-left break-all [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">{branchDetail.manager.designation}</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Contact Number:</span>
                    <span className="w-[65%] text-slate-300 font-mono text-left break-words [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">{branchDetail.manager.phone}</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Email Address:</span>
                    <span className="w-[65%] text-slate-300 text-[10px] text-left break-all [word-break:break-word] [overflow-wrap:break-word] whitespace-normal" title={branchDetail.manager.email}>{branchDetail.manager.email}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <p className="text-[10px] font-mono uppercase tracking-widest text-slate-400 font-bold">5. Account Opening Audit information</p>
                <div className="p-3.5 rounded-xl border border-[#141b44] bg-[#04081c]/60 space-y-2.5 text-xs w-full max-w-full box-border h-auto min-h-max">
                  <div className="flex items-start w-full gap-2 py-0.5 border-b border-[#141b44]/55 pb-1.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Opened By:</span>
                    <div className="w-[65%] text-left">
                      <span className="text-white font-bold block">Sarah Jenkins</span>
                      <span className="text-[10px] font-mono text-slate-400 block break-words [word-break:break-word] [overflow-wrap:break-word]">Senior Banking Officer (EMP-0101)</span>
                    </div>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5 border-b border-[#141b44]/55 pb-1.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Opening Timestamp:</span>
                    <span className="w-[65%] text-white font-mono text-left break-all [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">12 June 2024 at 10:45:32 AM IST</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Approved By:</span>
                    <div className="w-[65%] text-left">
                      <span className="text-[#d4af37] font-bold block">{branchDetail.manager.name}</span>
                      <span className="text-[10px] font-mono text-slate-400 block break-words [word-break:break-word] [overflow-wrap:break-word]">{branchDetail.manager.designation} ({branchDetail.manager.empId})</span>
              ...
              <div className="space-y-2">
                <p className="text-[10px] font-mono uppercase tracking-widest text-slate-400 font-bold">6. KYC Verification Profile</p>
                <div className="p-3.5 rounded-xl border border-[#141b44] bg-[#04081c]/60 space-y-2 text-xs w-full max-w-full box-border h-auto min-h-max">
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">KYC Status:</span>
                    <div className="w-[65%] text-left">
                  ...
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-mono font-semibold text-left flex-shrink-0 select-none">Verified By:</span>
                    <span className="w-[65%] text-white font-medium text-left break-words [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">Sarah Jenkins</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-mono font-semibold text-left flex-shrink-0 select-none">Compliance ID:</span>
                    <span className="w-[65%] text-slate-300 font-mono text-[10px] text-left break-words [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">EMP-001</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-mono font-semibold text-left flex-shrink-0 select-none">Verification Date:</span>
                    <span className="w-[65%] text-slate-300 font-mono text-left break-words [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">12 June 2024</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-mono font-semibold text-left flex-shrink-0 select-none">Verification Time:</span>
                    <span className="w-[65%] text-slate-300 font-mono text-left break-words [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">10:55:00 AM IST</span>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <p className="text-[10px] font-mono uppercase tracking-widest text-slate-400 font-bold">7. Account Activity Information</p>
                <div className="p-3.5 rounded-xl border border-[#141b44] bg-[#04081c]/60 space-y-2 text-xs w-full max-w-full box-border h-auto min-h-max">
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Last Secure Login:</span>
                    <span className="w-[65%] text-white font-mono mt-0.5 text-left break-all [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">12 June 2026, 09:30:11 AM IST</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5 border-t border-[#141b44]/50 pt-1.5 mt-1">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Last Ledger Transaction:</span>
                  ...
                  <div className="flex items-start w-full gap-2 py-0.5 border-t border-[#141b44]/50 pt-1.5 mt-1">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Last Deposit:</span>
                  ...
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Last Withdrawal:</span>
              ...
              <div className="space-y-2">
                <p className="text-[10px] font-mono uppercase tracking-widest text-slate-400 font-bold">8. Transaction Summary</p>
                <div className="p-3.5 rounded-xl border border-[#141b44] bg-[#04081c]/60 space-y-2 text-xs w-full max-w-full box-border h-auto min-h-max">
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Total Deposits:</span>
                  ...
                  <div className="flex items-start w-full gap-2 py-0.5">
                    <span className="w-[35%] text-slate-400 font-semibold text-left flex-shrink-0 select-none">Total Withdrawals:</span>
                  ...
                  <div className="flex items-start w-full gap-2 py-0.5 border-t border-[#141b44]/60 pt-2 font-black">
                    <span className="w-[35%] text-slate-350 font-semibold text-left flex-shrink-0 select-none">Current Balance:</span>
                    <span className="w-[65%] text-white font-mono font-bold text-left break-words [word-break:break-word] [overflow-wrap:break-word] whitespace-normal">{formatUSD(activeAccount.balance)}</span>
                  </div>
                  <div className="flex items-start w-full gap-2 py-0.5">
              ...
              <div className="space-y-3">
                <p className="text-[10px] font-mono uppercase tracking-widest text-slate-400 font-bold">9. Account History Timeline</p>
                
                <div className="relative border-l-2 border-[#17235a] ml-2.5 pl-4 space-y-4">
                  
                  {/* Event 1 */}
                  <div className="relative">
                    <span className="absolute -left-[21px] top-1 w-2.5 h-2.5 rounded-full bg-emerald-500 ring-4 ring-[#0d153a]" />
                    <div className="text-xs">
                      <div className="font-bold text-white">Event: Account Created</div>
                      <div className="text-[10px] text-slate-400 font-mono">12 June 2024 at 10:45:32 AM IST</div>
                      <div className="text-slate-300 text-[10px] mt-0.5">Responsible: Sarah Jenkins (EMP-0101)</div>
                      <div className="text-slate-400 text-[9px] italic mt-0.5">"Secure electronic registration initialized via Admin clearance portal."</div>
                    </div>
                  </div>

                  {/* Event 2 */}
                  <div className="relative">
                    <span className="absolute -left-[21px] top-1 w-2.5 h-2.5 rounded-full bg-blue-400 ring-4 ring-[#0d153a]" />
                    <div className="text-xs">
                      <div className="font-bold text-white">Event: KYC Completed</div>
                      <div className="text-[10px] text-slate-400 font-mono">12 June 2024 at 10:55:00 AM IST</div>
                      <div className="text-slate-300 text-[10px] mt-0.5">Responsible: Sarah Jenkins (EMP-001)</div>
                      <div className="text-slate-400 text-[9px] italic mt-0.5">"Liveness verification & biometric scan matching validated with zero contrast warnings."</div>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="text-xs">
                      <div className="font-bold text-white">Event: Branch Approval</div>
                      <div className="text-[10px] text-slate-400 font-mono">12 June 2024 at 11:20:15 AM IST</div>
                      <div className="text-slate-300 text-[10px] mt-0.5">Responsible: {branchDetail.manager.name} ({branchDetail.manager.empId})</div>
                      <div className="text-slate-400 text-[9px] italic mt-0.5">"Regulatory collateral buffers initialized and branch clearance approved."</div>
                    </div>
                  </div>

                  {/* Event 4 */}
                  <div className="relative">
                    <span className="absolute -left-[21px] top-1 w-2.5 h-2.5 rounded-full bg-indigo-500 ring-4 ring-[#0d153a]" />
                    <div className="text-xs">
                      <div className="font-bold text-white">Event: First Deposit</div>
                      <div className="text-[10px] text-slate-400 font-mono">12 June 2024 at 02:15:00 PM IST</div>
                      <div className="text-slate-300 text-[10px] mt-0.5">Responsible: System Automator</div>
                      <div className="text-slate-400 text-[9px] italic mt-0.5">"Initial reserve deposit wire received successfully."</div>
                    </div>
                  </div>

                  {/* Event 5 */}
                  <div className="relative">
                    <span className="absolute -left-[21px] top-1 w-2.5 h-2.5 rounded-full bg-rose-400 ring-4 ring-[#0d153a]" />
                    <div className="text-xs">
                      <div className="font-bold text-white">Event: Latest Transaction</div>
                      <div className="text-[10px] text-slate-400 font-mono">11 June 2026 at 04:12:45 PM IST</div>
                      <div className="text-slate-300 text-[10px] mt-0.5">Responsible: SWIFT Clearing Center</div>
                      <div className="text-slate-400 text-[9px] italic mt-0.5">"Real-time ledger value synchronized and verified."</div>
                    </div>
                  </div>
              ...
              <div className="space-y-2 border-t border-[#141b44] pt-4">
                <p className="text-[10px] font-mono uppercase tracking-widest text-slate-400 font-bold">10. Super Admin Actions</p>
                <div id="super-admin-action-block" className="grid grid-cols-2 gap-2 mt-2">
                  <button
                    ...
                    className="p-2 bg-[#04081c] border border-slate-700 hover:border-[#d4af37] text-[10px] font-mono font-bold text-white rounded-lg transition-colors cursor-pointer text-left flex items-center gap-1.5"
                  >
                  ...
                  <button
                    ...
                    className="p-2 bg-[#04081c] border border-slate-700 hover:border-blue-500 text-[10px] font-mono font-bold text-white rounded-lg transition-colors cursor-pointer text-left flex items-center gap-1.5"
                  >
                  ...
                  <button
                    ...
                    className="p-2 bg-[#04081c] border border-slate-700 text-[10px] font-mono text-slate-300 rounded-lg transition-all hover:bg-indigo-950/20 cursor-pointer flex items-center gap-1.5"
                  >
                  ...
                  <button
                    ...
                    className="p-2 bg-[#04081c] border border-slate-700 text-[10px] font-mono text-slate-300 rounded-lg transition-all hover:bg-indigo-950/20 cursor-pointer text-center col-span-2 flex items-center justify-center gap-1.5"
                  >
            ...
            <div className="py-12 text-center text-xs text-[#556994]">
          ...
          <div className="text-[10px] text-[#556994] font-mono leading-relaxed mt-4 pt-4 border-t border-[#131b40]/60">
